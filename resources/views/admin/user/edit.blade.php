    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.user.update', $user) }}" method="POST">
                ...
                <div id="member-section" style="display: {{ old('role', $user->role) == 'user' ? 'block' : 'none' }};">
                    <hr>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('toko_nama') is-invalid @enderror"
                                       id="toko_nama" name="toko_nama" value="{{ old('toko_nama', $user->toko ? $user->toko->nama : '') }}">
                                @error('toko_nama')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('toko_alamat') is-invalid @enderror"
                                          id="toko_alamat" name="toko_alamat" rows="2">{{ old('toko_alamat', $user->toko ? $user->toko->alamat : '') }}</textarea>
                                @error('toko_alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                    ...
                                    <div class="col-md-4 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox"
                                                   ...
                                                   {{ in_array($kategori->id, old('kategori_ids', $selectedKategoriIds)) ? 'checked' : '' }}>
